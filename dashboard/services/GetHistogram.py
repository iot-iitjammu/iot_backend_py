...
from dashboard.services.utils import (
    ...
    GroupDailyEnergyData, GroupWeeklyEnergyData, GroupMonthlyEnergyData
)
...
def getEnergyHistogram(input_obj: FetchHistogramInput) -> List[TimestampAndValueObjectSchema]:
    input_obj.ToTimeStamp = input_obj.Timestamp
    ...
    group_mapping: Dict[
        ...
        Periods.DailyGroup: GroupDailyEnergyData,
        Periods.WeeklyGroup: GroupWeeklyEnergyData,
        Periods.MonthlyGroup: GroupMonthlyEnergyData,
    }
